...
class Regestration21 extends StatefulWidget {
  const Regestration21({super.key});

  @override
  State<Regestration21> createState() => _Regestration21State();
}

class _Regestration21State extends State<Regestration21> {
  bool isLoading = true;
  loading() {
    setState(() {
      isLoading = !isLoading;
